...
export const TRANSLATIONS = {
  ky: {
    ...
    hero: {
      ...
      subtitle: 'Кыргызстандагы мугалимдерди жана менторлорду салыштырыңыз. Чыныгы окуучулардын пикирлерин окуп, туура тандоо жасаңыз.',
      searchPlaceholder: 'Кайсы курсту же мугалимди издеп жатасыз?',
      searchBtn: 'Издөө',
      popularLabel: 'Көп изделгендер:',
      popularTags: ['Python', 'Англис тили', 'SMM', 'Дизайн', 'Бухгалтерия', 'Wildberries'],
      statsReviews: 'пикир',
      statsCourses: 'курс',
      statsVerified: 'ырасталган пикир',
      warningsBtn: 'Шектүү курстарды көрүү'
    },
  ...
  ru: {
    ...
    hero: {
      ...
      subtitle: 'Сравнивайте преподавателей и менторов в Кыргызстане. Читайте честные отзывы студентов и делайте правильный выбор.',
      searchPlaceholder: 'Какой курс или преподавателя вы ищете?',
      searchBtn: 'Найти',
      popularLabel: 'Популярные запросы:',
      popularTags: ['Python', 'Английский язык', 'SMM', 'Дизайн', 'Бухгалтерия', 'Wildberries'],
      statsReviews: 'отзывов',
      statsCourses: 'курсов',
      statsVerified: 'подтверждённых отзывов',
      warningsBtn: 'Сомнительные курсы'
    },
