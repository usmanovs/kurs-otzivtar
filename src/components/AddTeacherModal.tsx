...
import { X, UserPlus, Upload, Trash2, Instagram, Youtube, Globe } from 'lucide-react';
...
export const AddTeacherModal: React.FC<AddTeacherModalProps> = ({
  ...
  const [websiteUrl, setWebsiteUrl] = useState(editingTeacher?.websiteUrl || '');
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1 flex items-center gap-1.5">
                ...
                {t.addTeacherModal.website}
              </label>
              <input
                type="url"
                id="new-teacher-website-input"
                value={websiteUrl}
