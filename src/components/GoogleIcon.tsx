...
/**
 * lucide-react carries no brand marks, so this is drawn directly — see
 * TikTokIcon for the same pattern. Google's mark is multi-color, unlike the
 * currentColor icons elsewhere, so it keeps its own fixed palette.
 */
